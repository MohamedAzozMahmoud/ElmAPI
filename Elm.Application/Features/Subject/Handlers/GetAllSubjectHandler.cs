...
{
    public sealed class GetAllSubjectHandler : IRequestHandler<GetAllSubjectQuery, Result<List<GetSubjectDto>>>
    {
        ...
        public async Task<Result<List<GetSubjectDto>>> Handle(GetAllSubjectQuery request, CancellationToken cancellationToken)
        {
